...
def main():
    ...
    while True:
        ...
        if not Quitter:
            # Variables
            liste_cercle_1, liste_cercle_2, tour, numero_tour, nb_max_tour, epargne_1, epargne_2 = chargement(Sauvegarde)
            liste_obstacle = []
            ...
            for element in liste_cercle_1:
                cercle(element[0], element[1], element[2], "black", couleurJoueur[0], tag = "Jeu " + str(element[3]))
            for element in liste_cercle_2:
                cercle(element[0], element[1], element[2], "black", couleurJoueur[1], tag = "Jeu " + str(element[3]))
            while not Retour:
